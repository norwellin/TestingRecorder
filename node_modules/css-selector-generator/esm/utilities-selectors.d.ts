 ...
 */
export declare function filterSelectors(list: CssSelector[] | undefined, matchBlacklist: PatternMatcher, matchWhitelist: PatternMatcher): CssSelector[];
/**
 * Prioritise whitelisted selectors in list.
 */
export declare function orderSelectors(list: CssSelector[] | undefined, matchWhitelist: PatternMatcher): CssSelector[];
/**
 ...
 */
export declare function getSelectorWithinRoot(elements: Element[], root: ParentNode, rootSelector: CssSelector | undefined, options: CssSelectorGeneratorOptions): null | CssSelector;
/**
 * Climbs through parents of the element and tries to find the one that is
 * identifiable by unique CSS selector.
 */
export declare function getClosestIdentifiableParent(elements: Element[], root: ParentNode, rootSelector: CssSelector | undefined, options: CssSelectorGeneratorOptions): IdentifiableParent;
/**
